...
public class RevocacionJPADAO implements RevocacionDAO {
	...
	public SearchResult<Revocacion> findAllByNumeroEscritura(Integer numeroEscritura) {
		String jpql = "select rv from Revocacion as rv where rv.numeroEscritura = :numeroEscritura";
		SearchResult<Revocacion> rs = new SearchResult<Revocacion>();
	...
	public SearchResult<Revocacion> findAllByFechaRevocacion(Integer max, Integer offset, String sort, String order,
		...
		if( (fechaDelDia != null && fechaDelMes != null && fechaDelAnio != null) && 
			(fechaDelDia > 0 && fechaDelMes > 0 && fechaDelAnio > 0) ){
			fechaDelCalendar.set(fechaDelAnio,fechaDelMes-1,fechaDelDia,00,00,00);
		}
		if( (fechaAlDia != null && fechaAlMes != null && fechaAlAnio != null) &&
			(fechaAlDia > 0 && fechaAlMes > 0 && fechaAlAnio > 0) ){
